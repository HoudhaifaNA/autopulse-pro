    ...
    return car_stock.map((carModel, ind) => {
      ...
      return (
        <T.TableRow key={name}>
          ...
          <T.TableCell>{bought_number}</T.TableCell>
          <T.TableCell>{sold_number}</T.TableCell>
          <T.TableCell>{in_stock}</T.TableCell>
        </T.TableRow>
      );
    });
  };
      ...
      <T.Table>
        ...
        <T.TableBody>
          <T.TableRow>
            ...
            <T.TableCell>{total.bought_number}</T.TableCell>
            <T.TableCell>{total.sold_number}</T.TableCell>
            <T.TableCell>{total.in_stock}</T.TableCell>
          </T.TableRow>
          {renderStock()}
        </T.TableBody>
      </T.Table>
