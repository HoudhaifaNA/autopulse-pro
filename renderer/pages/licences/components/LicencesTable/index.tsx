...
import ActionsDropdown from "pages/licences/components/ActionsDropdown";
...
const LicencesTable = ({ licences }: LicenceTableProps) => {
    ...
    return licences.map((licence, ind) => {
      ...
      return (
        <T.TableRow key={id} onClick={(event) => event.ctrlKey && checkId(id)}>
          ...
          <T.TableCell>{formattedLicencePrice}</T.TableCell>
